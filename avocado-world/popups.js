...
function getUrlData(counter) {
    switch (counter) {
        case 1:
            return ["https://medium.com/@angela.rae/the-miracle-of-life-779eda4f7ac3", 630, 700,
                "https://twitter.com/Things4WhitePpl/status/1116107411612295168", 413, 660
            ];
        case 2:
            return ["https://twitter.com/angielourae/status/559442720100339712", 413, 804,
                "https://youtu.be/MFmr_TZLpS0?t=174&autoplay=1", 413, 804
            ];
        case 3:
            return ["https://www.youtube.com/watch?v=DkYqWRgiIz4&autoplay=1", 413, 804,
                "https://medium.com/migration-issues/avocado-toast-is-ruining-this-country-44fa82afd248", 700, 700
            ];
        case 4:
            return ["https://www.youtube.com/watch?v=bE4C8a48o1E", 513, 804,
        ...
        case 6:
            return ["https://youtu.be/DhaG_Zi6izU", 413, 804,
        ...
        case 7:
            return ["https://www.refinery29.com/en-ca/2019/04/230021/oprah-avocado-orchard-daily-show", 413, 804,
                "https://youtu.be/Ih3dFWg3znI", 413, 804
            ];
        case 8:
        ...
        case 0:
            return ["https://docs.google.com/document/d/1RADjEKmTb5k2ddUc-iRGkulWpGMbfy9kUH895VSAx-E/edit?usp=sharing", 600, 600,
...
function popup(url1, height1, width1, url2, height2, width2) {
    ...
    left=300,top=300,resizable=yes,scrollbars=yes,toolbar=no,menubar=no,\
    location=no,directories=yes,status=no');
}